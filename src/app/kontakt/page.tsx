      ...
      <section className="section-space">
        <div className="site-container max-w-3xl">
          <div className="panel p-7 text-center md:p-10">
            <h1 className="font-script text-6xl text-primary/80 md:text-7xl">{contact_page.title}</h1>
            ...
            <div className="mt-8 grid gap-5 rounded-2xl border border-primary/10 bg-white/70 p-5 text-left md:p-6">
              ...
              <div>
                ...
                <div className="mt-2 space-y-2 text-sm">
                  <p>
                    <a href={`tel:${footer.address.phone}`} className="text-muted-foreground hover:text-primary">
                  ...
                  <p>
                    <a
                      ...
                      className="inline-flex items-center gap-1 font-semibold text-primary underline decoration-primary/40 underline-offset-4 transition-colors hover:text-primary/80"
                    >
